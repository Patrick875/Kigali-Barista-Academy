...
import { singleResponseObject } from "./types";

interface Props {
	show: boolean;
	setShow: (show: boolean) => void;
	setPorts: React.Dispatch<React.SetStateAction<singleResponseObject[]>>;
	itemId: string;
	collectionName: string;
}
const DeleteItemModal = ({ show, setShow, itemId, setPorts, collectionName }: Props) => {
